...
import ao.com.aristides.todolist.utils.Utils;
import jakarta.servlet.http.HttpServletRequest;

@RestController //Classe controller
@RequestMapping("/tasks") //URL para a tarefa
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request){
        ...
        taskModel.setIdUser(idUser); //Pega o id do User que cria a tarefa
        
        LocalDateTime currentDate = LocalDateTime.now(); //Faz a validação da data de começo
        ...
        if(taskModel.getStartAt().isAfter(taskModel.getEndAt())){ //Faz a validação da data de término
    ...
    @GetMapping("/")//Função que lista as tarefas
